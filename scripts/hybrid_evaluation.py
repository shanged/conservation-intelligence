...
def evaluate_hybrid(
    ...
    *,
    ...
    return {
        ...
        "citation_valid": valid,
        "insufficient": response.insufficient,
        "fallback": response.mode == "deterministic_fallback",
        "fallback_reason": response.fallback_reason,
        "mode": response.mode,
        "model": diagnostics.get("model") or config.model,
        "usage": usage,
        "citation_repair_attempted": bool(diagnostics.get("citation_repair_attempted", False)),
        "repair_input_tokens": diagnostics.get("repair_input_tokens", 0),
        "repair_output_tokens": diagnostics.get("repair_output_tokens", 0),
